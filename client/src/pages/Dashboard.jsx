          ...
          {loading ? <Loader /> : (
            <>
              <div className='pt-8 flex justify-center items-center text-4xl'>
                <p className='pb-3 border-b border-gray-600 text-center font-medium w-1/2'>لوحة التحكم</p>
              </div>
