...
export const JobsLayout = () => {
  ...
  const data = ["تكنولوجيا", "تسويق", "مالية", "مبيعات", "قانوني"];
                ...
                <div className='flex  justify-center w-full  items-center  '>
                  <div className='bg-white flex md:w-2/5 w-4/5'>
                    ...
                    ${search.length !== 0 ? "flex" : "hidden"}
                     `} /></div>
                    <button onClick={() => searchHandler()} className='blueCol px-4 md:h-10 h-8 py-1'>بحث</button>
                  </div>
                </div>
              </div>
                ...
                <div className='filter1  md:flex hidden flex-col'>
                  <div className='flex justify-start  flex-col filter  '>
                    ...
                    <div className='flex flex-col gap-4 w-2/3 pt-5'>
                      <button onClick={() => filter()} className='blueCol px-1 py-1 text-sm'>تطبيق الفلتر</button>
                      <button className='blueCol px-1 py-1 text-sm'>إزالة الفلتر</button>
                    </div>
                  </div>
                </div>
                ...
                <div className='filter2  md:flex hidden flex-col ml-16'>
                  <div className='flex justify-end  flex-col filter  '>
                    ...
                    <div className='flex flex-col gap-4 pt-5'>
                      <button className='blueCol px-1 py-1 text-sm'>تطبيق الفلتر</button>
                      <button className='blueCol px-1 py-1 text-sm'>إزالة الفلتر</button>
                    </div>
                  </div>
                </div>
