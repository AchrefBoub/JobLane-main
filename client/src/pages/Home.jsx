            ...
            <div className='min-h-screen md:px-20 px-3 pt-14 flex text-white bg-gray-950'>
                <div className='w-full flex pt-28 flex-col justify-start items-center gap-4'>
                    <div className='flex md:flex-row flex-col items-center justify-center md:gap-10 gap-1'>
                        <div className='md:text-8xl text-red-700 text-6xl titleT '>دلني</div>
                        <div className='flex justify-center items-center pt-1'>
                            <Link to="/jobs" className='font-semibold md:text-2xl text-lg blueCol md:py-3 py-2 px-6 md:px-10'>تصفح الوظائف</Link>
                        </div>
                    </div>
                    <div>
                        <p className='md:text-xl text-sm'>بوابتك <span className='text-red-700'>دليلك للكسب الطيب</span>.</p>
                    </div>
                    <div className='pt-[8rem] md:px-[1rem] px-[0rem] w-full'>
                        <div className='titleT pb-6 text-2xl'>
                            <p className='titleT'>وظائف مميزة</p>
                        </div>
                        <div>
                            {loading ? 
                    ...
                    <div className="pt-[7rem] pb-[10rem] md:px-[14rem] px-[1rem] text-center">
                        <p>اكتشف قوة الإمكانية مع دلني: حيث تبدأ رحلتك المهنية بشبكة من الفرص المتنوعة!</p>
                    </div>
                </div>
            </div>
        </>
