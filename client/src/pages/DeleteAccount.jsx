        ...
        <>
            ...
            <div className='bg-gray-950 min-h-screen pt-14 md:px-20 px-3 text-white' dir="rtl">
                <div className='flex justify-center w-full items-start pt-14'>
                    <form onSubmit={deleteHandler} className='flex flex-col md:w-1/3 shadow-gray-700 w-full md:mx-0 mx-4'>
                        <div className='md:px-10 px-6 py-6 shadow-sm shadow-gray-700 border-gray-700 border w-full flex flex-col gap-4'>
                            <div className='text-center pb-3'>
                                <p className='md:text-4xl text-3xl font-semibold border-b pb-2 border-gray-700'>حذف الحساب</p>
                            </div>
                            ...
                            <div className='flex gap-2'>
                                <div className='pt-1.5 cursor-pointer'>
                                    <Checkbox className='cursor-pointer' onClick={() => setConfirm(!confirm)} />
                                </div>
                                <div>
                            ...
                            <div>
                                <button 
                                    ...
                                    {loading ? <TbLoader2 className='animate-spin' size={24} /> : "حذف"}
                                </button>
                            </div>
                        </div>
                    </form>
