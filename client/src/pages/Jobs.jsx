...
export const Jobs = () => {
  ...
  const [baseJobs, setBaseJobs] = useState([]); // حالة جديدة للوظائف الأساسية
  ...
  const data = ["تكنولوجيا", "تسويق", "مالية", "مبيعات", "قانونية"]
  ...
  useEffect(() => {
    setJobs(allJobs);
    setBaseJobs(allJobs); // تعيين الوظائف الأساسية عند تغيير allJobs
  }, [allJobs])
  ...
  const pageButtons = [];
  const maxButtonsToShow = 3; // الحد الأقصى لعدد أزرار الصفحات المعروضة
              ...
              <div className='py-3 pt-4 w-full flex justify-center items-center'>
                <div className='flex  justify-center w-full  items-center  '>
                  <div className='bg-white flex md:w-2/5 w-4/5'>
                    ...
                    <input value={search} placeholder='ابحث عن وظائف' onChange={(e) => setSearch(e.target.value)} type="text" className='outline-none bold-placeholder   text-black px-2 pl-3 md:h-10 w-full h-8 py-1 text-sm' />
                    ...
                    ${search.length !== 0 ? "flex" : "hidden"}
                     `} /></div>
                    <button onClick={() => searchHandler()} className='blueCol md:text-sm text-xs px-4 md:h-10 h-8 py-1'>ابحث</button>
                  </div>
                </div>
              </div>
              <div className=' flex flex-col pt-1 justify-between md:flex-row w-full '>
                <div className='filter1  md:flex hidden flex-col'>
                  <div className='flex justify-start  flex-col filter  '>
                    <p className='text-xl underline underline-offset-4'>التصنيفات</p>
                    ...
                    <div className='pt-5'>
                      <p className='text-xl pb-3 underline underline-offset-4'>الراتب</p>
                      <Slider
                        color="indigo"
                    ...
                    <div className='flex flex-col gap-4 w-2/3 pt-5'>
                      <button onClick={() => leftFilter()} className='blueCol px-1 py-1 text-xs'>تطبيق الفلتر</button>
                      <button onClick={() => removeLeftFilter()} className='blueCol px-1 py-1 text-xs'>إزالة الفلتر</button>
                    </div>
                  </div>
                </div>
                <div className='md:w-2/4 pb-20 pt-2'>
                  <div className='flex  flex-col md:overflow-y-auto  md:max-h-[30em] gap-4'>
                    ...
                    <div className={`${jobs.length === 0 ? "flex" : "hidden"}  w-full  justify-center items-center  text-center pt-16 pb-12 md:text-xl text-lg    `}>
                      لا توجد وظائف متاحة وفقًا لتفضيلاتك
                    </div>
                  </div>
                    ...
                    <div className='flex  flex-col'>
                      ...
                      <div className='flex  justify-between pt-10 px-6'>
                        <div className='filter1  md:hidden flex flex-col'>
                          <div className='flex justify-start  flex-col filter  '>
                            <p className='text-lg underline underline-offset-4'>التصنيفات</p>
                        ...
                        <div className='filter2  md:hidden flex flex-col ml-16'>
                          <div className='flex justify-end  flex-col filter  '>
                            <p className='text-lg underline underline-offset-4'>الشركات</p>
                            ...
                            <div className='flex text-sm flex-col gap-4 pt-5'>
                              <button onClick={() => rightFilter()} className='blueCol px-1 py-1 text-xs'>تطبيق البحث</button>
                              <button onClick={() => removeRightFilter()} className='blueCol px-1 py-1 text-xs'>إزالة البحث</button>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className='filter2  md:flex hidden flex-col ml-16'>
                  <div className='flex justify-end  flex-col filter  '>
                    <p className='text-xl underline underline-offset-4'>الشركات</p>
                    <div className='pt-3 flex flex-col justify-end text-right gap-3'>
                      {companyData.map(e => (
