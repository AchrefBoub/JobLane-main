...
export const SavedJobs = () => {
  ...
  return (
    <>
      <MetaData title="الوظائف المحفوظة" />
      <div className='bg-gray-950 min-h-screen pt-14 md:px-20 px-3  text-white'>

        {loading ? <Loader /> :

          <div className='pt-6 md:px-28  px-1 pb-32' >
            {savedJobs.length !== 0 && <div className='text-center text-3xl pb-4 font-medium'>الوظائف المحفوظة</div>}
            {
              <div className='flex flex-col gap-4'>
                {reverseArr(savedJobs.slice()).map((job, i) => (
            ...
            }
            {
              ...
              <div className='pt-10 text-center flex flex-col justify-center items-center'>
                ...
                <p className='md:text-3xl pb-3 pt-4 text-xl '>ليس لديك أي وظائف محفوظة!</p>
