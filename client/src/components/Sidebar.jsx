            ...
            >
                ...
                <div className='flex justify-center  md:pl-12 pl-3 flex-col gap-14 items-start pt-20'>
                    ...
                    <div className='flex justify-center gap-2 items-center'>
                        <Link to="/admin/dashboard" className='flex blueCol px-4 py-1 justify-center gap-2 items-center'> <MdOutlineDashboard size={20} /> الرئيسية</Link>
                    </div>

                    <div className='flex justify-center gap-2 items-center'>
                        <Link to="/admin/postJob" className='flex blueCol px-4 py-1 justify-center gap-2 items-center'> <MdOutlineCreateNewFolder size={20} /> نشر وظيفة</Link>
                    </div>

                    <div className='flex justify-center gap-2 items-center'>
                        <Link to="/admin/allJobs" className='flex blueCol px-4 py-1 justify-center gap-2 items-center'>
                            <BsBriefcase size={20} /> عرض كل الوظائف
                        </Link>
                    </div>
                    <div className='flex justify-center gap-2 items-center'>
                    ...
                    <div className='flex justify-center gap-2 items-center'>
                        <Link to="/admin/allUsers" className='flex blueCol px-4 py-1 justify-center gap-2 items-center'>
                            <AiOutlineUser size={20} /> عرض كل المستخدمين
                        </Link>
                    </div>
