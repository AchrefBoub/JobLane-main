                ...
                <div className='flex flex-col '>
                    ...
                    <div className='flex justify-between gap-2 '>
                        ...
                        <div className='absolute md:right-3 right-0 md:pt-0 top-7 text-sm flex flex-col gap-6' >
                            <Link to={`/details/${job._id}`} className='blueCol font-semibold md:text-sm text-xs px-3 py-1 text-center ' >تقديم الآن</Link>
                            <button onClick={unSaveJobHandler} className='blueCol font-semibold md:text-sm text-xs px-3 py-1 text-center ' >إلغاء الحفظ</button>
                        </div>
                    </div>
